...
public class CadastroImovel implements Serializable {
	...
	public List<Imovel> carregarImoveis() {
		...
		if((Integer.parseInt(filtrarMetrosQuadradosMinimo) > Integer.parseInt(filtrarMetrosQuadradosMaximo))) {	 
            metrosMessageError = "Filtro de metros quadrados est�o incorretos";
            return imoveis;
		} else {
			metrosMessageError = "";
		}
		...
		if((Integer.parseInt(filtrarValorMinimo) > Integer.parseInt(filtrarValorMaximo))) {
            ...
            context.addMessage(metrosMessage.getClientId(context), 
                    new FacesMessage("", "Filtro de valores est�o incorretos"));	    
            valorMessageError = "Filtro de valores est�o incorretos";
		} else {
			valorMessageError = "";
		}
...
//        return imoveis;    
    ...
    public void setFiltrar(boolean filtrar) {
		...
		if((Integer.parseInt(filtrarMetrosQuadradosMinimo) > Integer.parseInt(filtrarMetrosQuadradosMaximo))) {
	        FacesContext context = FacesContext.getCurrentInstance();
            context.addMessage(metrosMessage.getClientId(context), 
                    new FacesMessage("", "Filtro de metros quadrados est�o incorretos"));	    
            metrosMessageError = "Filtro de metros quadrados est�o incorretos";
		} else {
            metrosMessageError = "";
		}
